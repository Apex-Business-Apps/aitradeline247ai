      ...
      <div className="container">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-8 min-h-[10.9375rem] md:min-h-[14.0625rem] items-center">
            <img src="/src/assets/official-logo.svg" alt="TradeLine 24/7 Logo" className="h-[8.75rem] md:h-[11.25rem] w-auto opacity-80" style={{ transform: 'translateY(-0.5cm) scale(1.45) scaleY(1.3225) scaleX(1.15)' }} />
          </div>
