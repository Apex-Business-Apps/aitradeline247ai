...
const plans = [{
  ...
  features: ["Up to 100 calls/month", "Basic AI responses", "Email integration", "Call transcription"],
  ...
  features: ["Up to 1,000 calls/month", "Advanced AI capabilities", "CRM integration", "Advanced analytics"],
  cta: "Start Free Trial",
  popular: true
}, {
  name: "Enterprise",
  ...
  features: ["Unlimited calls", "Custom AI training", "Full API access", "Advanced security"],
  cta: "Contact Sales",
  popular: false
}];
  ...
  return <section className="py-20 bg-gradient-orange-subtle section-heavy">
      <div className="container">
        ...
        <div className="text-center mb-16">
          {/* Hero Logo */}
          <div className="mb-2">
            <img src={officialLogo} alt="TradeLine AI - 24/7 AI Receptionist" className="h-48 md:h-[18.15rem] lg:h-[21.78rem] w-[46.2rem] md:w-[69.875rem] lg:w-[83.85rem] mx-auto drop-shadow-2xl -mt-20" width="420" height="120" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => <Card key={index} className={`relative ${plan.popular ? 'ring-2 ring-primary shadow-xl scale-105' : ''}`}>
              ...
              <CardContent className="space-y-4">
                ...
                <Button className="w-full" variant={plan.popular ? "default" : "outline"} size="default">
                  {plan.cta}
                </Button>
              </CardContent>
            </Card>)}
