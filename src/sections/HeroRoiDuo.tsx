      ...
      <div className="container" data-lovable-lock="permanent">
        ...
        <div className="text-center mb-16" data-lovable-lock="permanent">
          ...
          <h1 id="hero-h1" className="mb-6 bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent font-extrabold" style={{ fontSize: 'clamp(2rem, 5vw + 1rem, 4.5rem)', lineHeight: '1.1' }} data-lovable-lock="permanent">
            Your 24/7 A<span className="text-primary" data-lovable-lock="permanent">i</span> Receptionist
          </h1>
          ...
          <a 
            ...
            data-lovable-lock="permanent"
          >
            <svg className="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-lovable-lock="permanent">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" data-lovable-lock="permanent" />
            </svg>
            <span data-lovable-lock="permanent">587-742-8885</span>
            <span className="text-sm font-semibold uppercase tracking-wide text-primary/80" data-lovable-lock="permanent">FOR DEMO</span>
          </a>
